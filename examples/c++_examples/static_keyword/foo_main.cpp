// to compile this file: do g++ foo_main.cpp foo_funcs.cpp. Since all included
// files are here, we don't need '-I'
...
// source file and avoid potential naming conflict
static void test_bar() { std::cout << "test bar: main" << std::endl; }
...
public:
  ...
  static void foo_static() { cout << __FUNCTION__ << endl; }
...
// If in hpp, then every instance will get the same value. Else, should be in
// the source file.
int Foo::i(123);
